...
func init() {
	...
	errs.Add(
		...
		consts.ActionRegistry.Register(&actions.CreateAsset{}, action.Unmarshal.CreateAsset, false)
		// TODO: register action: actions.MintAsset
		consts.ActionRegistry.MintAsset(&actions.MintAsset{},actions.UnmarshalMintAsset, false)
